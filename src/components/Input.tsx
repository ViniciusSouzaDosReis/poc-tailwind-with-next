...
export function Input({ icon: Icon, ...props }: InputProps) {
  return (
    <div className="flex w-full items-center gap-2 rounded-lg border border-solid border-zinc-300 px-3 py-2 focus-within:border-purple-300 focus-within:shadow-sm">
